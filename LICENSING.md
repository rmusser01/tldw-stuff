...
| [un-aligned waifu](buddy-packs/un-aligned-waifu/README.md) | Apache-2.0 for project contributions to the extent applicable; supplied reference artwork credited to anonymous, with no published reference license verified; reference and character rights remain separate in [NOTICE.txt](buddy-packs/un-aligned-waifu/NOTICE.txt) |
