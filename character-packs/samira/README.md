...
- [Original Chatbook card](assets/characters/samira/Samira.character.json): unchanged Character Card V2 JSON.
...
Content version: **1.0.0** (2026-09-05 snapshot). Requires a compatible application;
...
All original source files are byte-identical. The server-compatible JSON is a
separate, explicitly adapted file. The original card retains its creator metadata.
