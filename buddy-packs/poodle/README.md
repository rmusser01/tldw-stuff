...
A seated cream poodle with a curly topknot, two floppy ears, slim forelegs and a pom-pom tail. Reactions use its eyes, muzzle and tail without extra arms or chest puffs.

## Preview and download

<img src="preview.png" alt="Poodle still preview" width="192" height="192"> <img src="preview.gif" alt="Poodle animated expression preview" width="192" height="192">

[**Download Poodle**](poodle.tldw-persona-vpack) · 241,513 bytes · [SHA-256 checksums](SHA256SUMS)
...
only facial regions over a fixed base; thinking changes detached thought dots. The listening frame reuses the two-eared idle body with attention strokes, excluding extra generated ear shapes.
...
```sh
python scripts/build_buddy_collection.py buddy-packs/poodle
python tests/check_buddy_collection.py --host chatbook --pack poodle
python tests/check_buddy_collection.py --host server --pack poodle
```
