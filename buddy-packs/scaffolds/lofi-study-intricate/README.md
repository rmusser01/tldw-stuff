# Lo-fi Study Intricate — scaffold

Catalog scaffold fixture, not final character art or animation: Original study companion starter with atlas-backed loops and tool variant metadata.
...
- [lofi-study-intricate.tldw-persona-vpack](lofi-study-intricate.tldw-persona-vpack): native portable archive, 3,152 bytes, containing 1 PNG assets and 6 state mappings.
...
States: `error`, `idle`, `listening`, `speaking`, `thinking`, `tool.research`.

## Verification

Native server export, preview and committed import succeeded, producing a
new draft with 1 matching asset checksums and 6 states.
Native Chatbook import, publication to a temporary profile/SQLite database,
and active-graph reload also succeeded with 1 assets.
