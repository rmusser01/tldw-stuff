# Object Creature Intermediate — scaffold

Catalog scaffold fixture, not final character art or animation: Non-human expressive object starter to show the format is not humanoid-only.
...
- [object-creature-intermediate.tldw-persona-vpack](object-creature-intermediate.tldw-persona-vpack): native portable archive, 5,217 bytes, containing 6 PNG assets and 6 state mappings.
