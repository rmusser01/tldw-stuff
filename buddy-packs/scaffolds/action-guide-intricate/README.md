# Action Guide Intricate — scaffold

Catalog scaffold fixture, not final character art or animation: Energetic guide starter with reaction beats and richer state metadata.
...
- [action-guide-intricate.tldw-persona-vpack](action-guide-intricate.tldw-persona-vpack): native portable archive, 5,651 bytes, containing 7 PNG assets and 7 state mappings.
...
States: `error`, `idle`, `listening`, `reaction.anticipation`, `reaction.success`, `speaking`, `thinking`.
