# Study Desk Intermediate — scaffold

Catalog scaffold fixture, not final character art or animation: Calm study companion starter with separate required-state frame assets.
...
- [study-desk-intermediate.tldw-persona-vpack](study-desk-intermediate.tldw-persona-vpack): native portable archive, 4,694 bytes, containing 5 PNG assets and 5 state mappings.
...
States: `error`, `idle`, `listening`, `speaking`, `thinking`.

## Verification

Native server export, preview and committed import succeeded, producing a
new draft with 5 matching asset checksums and 5 states.
Native Chatbook import, publication to a temporary profile/SQLite database,
and active-graph reload also succeeded with 5 assets.
