...
A classic yellow rubber bath duck with an orange beak and tiny wings.

## Preview and download

<img src="preview.png" alt="Rubber Duck still preview" width="192" height="192"> <img src="preview.gif" alt="Rubber Duck animation and reaction preview" width="192" height="192">

[**Download Rubber Duck**](rubber-duck.tldw-persona-vpack) · 200,022 bytes · [SHA-256 checksums](SHA256SUMS)
