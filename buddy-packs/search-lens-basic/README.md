...
Bundled art-ready basic Buddy default: friendly magnifying-glass research helper with approved 3x4 source-sheet frames.

## Preview

<img src="preview.png" alt="Search Lens Basic Buddy preview" width="192" height="192">
...
- [search-lens-basic.tldw-persona-vpack](search-lens-basic.tldw-persona-vpack): native portable archive, 146,530 bytes, containing 13 PNG assets and 6 state mappings.
...
Select `idle`, `thinking` and `speaking` to see the companion's matching state loops; `reaction.success` supplies a celebratory pose.

States: `error`, `idle`, `listening`, `reaction.success`, `speaking`, `thinking`.

## Verification

Native server export, preview and committed import succeeded, producing a
new draft with 13 matching asset checksums and 6 states.
Native Chatbook import, publication to a temporary profile/SQLite database,
and active-graph reload also succeeded with 13 assets.
