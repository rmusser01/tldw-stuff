...
A golden triangular companion with a simple face and tiny hands.

## Preview and download

<img src="preview.png" alt="Triangle still preview" width="192" height="192"> <img src="preview.gif" alt="Triangle animation and reaction preview" width="192" height="192">

[**Download Triangle**](triangle.tldw-persona-vpack) · 166,552 bytes · [SHA-256 checksums](SHA256SUMS)
