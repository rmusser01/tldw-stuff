...
A friendly chestnut horse with a white forehead blaze, a dark mane and tail, and a tan muzzle. Facial reactions and a greeting tail flick keep the four-legged stance grounded.

## Preview and download

<img src="preview.png" alt="Horse still preview" width="192" height="192"> <img src="preview.gif" alt="Horse animated expression preview" width="192" height="192">

[**Download Horse**](horse.tldw-persona-vpack) · 201,053 bytes · [SHA-256 checksums](SHA256SUMS)
...
```sh
python scripts/build_buddy_collection.py buddy-packs/horse
python tests/check_buddy_collection.py --host chatbook --pack horse
python tests/check_buddy_collection.py --host server --pack horse
```
