...
Bundled art-ready basic Buddy default: compact terminal-window tile helper with approved 3x4 source-sheet frames.

## Preview

<img src="preview.png" alt="Terminal Tile Basic Buddy preview" width="192" height="192">
...
- [terminal-tile-basic.tldw-persona-vpack](terminal-tile-basic.tldw-persona-vpack): native portable archive, 67,936 bytes, containing 13 PNG assets and 6 state mappings.
