...
A pale ivory unicorn with a lavender mane and tail, a small golden horn and expressive eyes. Reactions use its face, ears and tail while its hooves stay planted.

## Preview and download

<img src="preview.png" alt="Unicorn still preview" width="192" height="192"> <img src="preview.gif" alt="Unicorn animated expression preview" width="192" height="192">

[**Download Unicorn**](unicorn.tldw-persona-vpack) · 234,786 bytes · [SHA-256 checksums](SHA256SUMS)
...
```sh
python scripts/build_buddy_collection.py buddy-packs/unicorn
python tests/check_buddy_collection.py --host chatbook --pack unicorn
python tests/check_buddy_collection.py --host server --pack unicorn
```
