Adapted for Chatbook from Notion Labs’ meeting template.
...
2. **Gather Chatbook note content**: Search and read relevant notes
3. **Enrich with research**: Add source-backed context when requested
4. **Customize as needed**: Adapt template to specific situation
5. **Prepare early**: Produce the draft with enough time for review; sharing is a separate action
