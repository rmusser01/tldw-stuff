...
- Author credit from upstream: **Teknium (teknium1), Hermes Agent**; publisher: **NousResearch and upstream contributors**.
- [Original source](https://github.com/NousResearch/hermes-agent/tree/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/creative/songwriting-and-ai-music) at `245e48008fa814b3251f50755eb656bd9fb86cb1`, retrieved 2026-09-05.
- [History and contributors](https://github.com/NousResearch/hermes-agent/commits/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/creative/songwriting-and-ai-music).
...
User-provided creative direction; external music generation needs the chosen service and account. This content does not provide a music model or credentials.

Follow the [directory import guide](../../IMPORT.md), selecting this individual
folder or its SKILL.md. Example: ask the assistant to use `songwriting-and-ai-music` for the
