...
- [Original source](https://github.com/NousResearch/hermes-agent/tree/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/productivity/teams-meeting-pipeline) at `245e48008fa814b3251f50755eb656bd9fb86cb1`, retrieved 2026-09-05.
- [History and contributors](https://github.com/NousResearch/hermes-agent/commits/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/productivity/teams-meeting-pipeline).
...
Hermes meeting-pipeline tools, Microsoft Graph app registration, tenant/client credentials and administrator-consented permissions. The Hermes pipeline is not bundled or provided by Chatbook import.

Follow the [directory import guide](../../IMPORT.md), selecting this individual
folder or its SKILL.md. Example: ask the assistant to use `teams-meeting-pipeline` for the
