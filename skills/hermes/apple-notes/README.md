...
- [Original source](https://github.com/NousResearch/hermes-agent/tree/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/apple/apple-notes) at `245e48008fa814b3251f50755eb656bd9fb86cb1`, retrieved 2026-09-05.
- [History and contributors](https://github.com/NousResearch/hermes-agent/commits/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/apple/apple-notes).
...
macOS, Notes.app, memo CLI, and Automation access. Reads and edits the selected Apple Notes account.

Follow the [directory import guide](../../IMPORT.md), selecting this individual
folder or its SKILL.md. Example: ask the assistant to use `apple-notes` for the
