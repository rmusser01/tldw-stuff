...
- [Original source](https://github.com/NousResearch/hermes-agent/tree/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/research/llm-wiki) at `245e48008fa814b3251f50755eb656bd9fb86cb1`, retrieved 2026-09-05.
- [History and contributors](https://github.com/NousResearch/hermes-agent/commits/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/research/llm-wiki).
...
Authorized filesystem tools, a chosen Markdown knowledge-base directory, and source content. Writes linked notes; does not automatically integrate with Chatbook notes or chatdictionaries.

Follow the [directory import guide](../../IMPORT.md), selecting this individual
folder or its SKILL.md. Example: ask the assistant to use `llm-wiki` for the
