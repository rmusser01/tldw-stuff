...
- Author credit from upstream: **Hermes Agent (inspired by Claude Code /simplify)**; publisher: **NousResearch and upstream contributors**.
- [Original source](https://github.com/NousResearch/hermes-agent/tree/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/software-development/simplify-code) at `245e48008fa814b3251f50755eb656bd9fb86cb1`, retrieved 2026-09-05.
- [History and contributors](https://github.com/NousResearch/hermes-agent/commits/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/software-development/simplify-code).
...
An editable checkout, project checks, and agent delegation tools. Hermes parallel-agent orchestration is not installed by importing this skill.

Follow the [directory import guide](../../IMPORT.md), selecting this individual
folder or its SKILL.md. Example: ask the assistant to use `simplify-code` for the
