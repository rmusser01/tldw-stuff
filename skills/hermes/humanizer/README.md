...
- Author credit from upstream: **Siqi Chen (@blader, https://github.com/blader/humanizer), ported by Hermes Agent**; publisher: **NousResearch and upstream contributors**.
- [Original source](https://github.com/NousResearch/hermes-agent/tree/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/creative/humanizer) at `245e48008fa814b3251f50755eb656bd9fb86cb1`, retrieved 2026-09-05.
- [History and contributors](https://github.com/NousResearch/hermes-agent/commits/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/creative/humanizer).
...
The original [Siqi Chen MIT notice](LICENSE) is also retained.
...
Text supplied by the user and optional authorized file-editing tools. Preserves upstream Siqi Chen attribution and MIT license; no external account required for editing supplied text.

Follow the [directory import guide](../../IMPORT.md), selecting this individual
folder or its SKILL.md. Example: ask the assistant to use `humanizer` for the
