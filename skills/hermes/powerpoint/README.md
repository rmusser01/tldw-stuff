...
- [Original source](https://github.com/NousResearch/hermes-agent/tree/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/productivity/powerpoint) at `245e48008fa814b3251f50755eb656bd9fb86cb1`, retrieved 2026-09-05.
- [History and contributors](https://github.com/NousResearch/hermes-agent/commits/245e48008fa814b3251f50755eb656bd9fb86cb1/skills/productivity/powerpoint).
...
The skill’s own [MIT notice](LICENSE) is also retained.
...
Python 3.10+ and python-pptx. LibreOffice plus Poppler are optional for rendering/PDF output. Helpers create/read/edit PPTX; render availability is reported separately.

Follow the [directory import guide](../../IMPORT.md), selecting this individual
folder or its SKILL.md. Example: ask the assistant to use `powerpoint` for the
