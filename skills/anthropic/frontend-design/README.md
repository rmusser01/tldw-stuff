...
Deliberate visual design for web interfaces.

## Attribution and files

- Author/publisher: **Anthropic, PBC and upstream contributors**.
- Original source: [anthropics/skills / skills/frontend-design](https://github.com/anthropics/skills/tree/41bbe19d1a1a7eaab5e7bb9050a417e5c6cffc8f/skills/frontend-design).
...
- [Upstream contributors and file history](https://github.com/anthropics/skills/commits/41bbe19d1a1a7eaab5e7bb9050a417e5c6cffc8f/skills/frontend-design).
...
A coding agent with project file access; browser or screenshot tools for visual review. External assets or packages need separate access.

## Import or use

Follow the [collection import guide](../../IMPORT.md). Select this exact directory,
`skills/anthropic/frontend-design`, or its `SKILL.md` in Chatbook’s local Skills library.
...
Example request: “Design a readable research-library interface for my project.”
