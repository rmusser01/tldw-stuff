...
Create standalone SVG/HTML or editable Excalidraw diagrams.

## Attribution and files

- Author/publisher: **OpenClaw Foundation and upstream contributors**.
- Original source: [openclaw/openclaw / skills/diagram-maker](https://github.com/openclaw/openclaw/tree/047587a542ce205ee78354fbd88ba8ec05c07844/skills/diagram-maker).
...
- [Upstream contributors and file history](https://github.com/openclaw/openclaw/commits/047587a542ce205ee78354fbd88ba8ec05c07844/skills/diagram-maker).
...
An LLM with file output; a browser or Excalidraw to view results. No required network service or bundled executable script.

## Import or use

Follow the [collection import guide](../../IMPORT.md). Select this exact directory,
`skills/openclaw/diagram-maker`, or its `SKILL.md` in Chatbook’s local Skills library.
...
Example request: “Draw a diagram of ingestion, chunking, indexing, and retrieval.”
