...
- [Sanity](integrations/sanity.md) — GROQ queries, mutations, CLI
- [Contentful](integrations/contentful.md) — Delivery/Management APIs, publishing
- [Strapi](integrations/strapi.md) — REST CRUD, filters, document API
