...
Plan content pillars, prioritized topics and distribution around audience needs.

Example request: “Build a content plan from this customer research, identifying evidence gaps and priority topics.”

## Source and license

- Author/publisher: **Corey Haines**.
- [Original source](https://github.com/coreyhaines31/marketingskills/tree/5b2c0007766c6a1cf1d53fd8fc73e979e0821022/skills/content-strategy) and [history/contributors](https://github.com/coreyhaines31/marketingskills/commits/5b2c0007766c6a1cf1d53fd8fc73e979e0821022/skills/content-strategy).
- Pinned revision: `5b2c0007766c6a1cf1d53fd8fc73e979e0821022`, retrieved **2026-09-05**.
...
- SKILL.md and other upstream content are unchanged except for integration-guide link paths; the linked guides are included unchanged in references/integrations/. No endorsement is implied.
...
An LLM and supplied product/customer context suffice for planning. Keyword research, competitive research, CMS work and publishing require appropriate authorized tools and data. Upstream product-context paths and related skills are not created or installed by import.
...
helper checks, and record observed limits. Preserve the documented integration-link relocation and source hashes; do not silently rewrite upstream text.
